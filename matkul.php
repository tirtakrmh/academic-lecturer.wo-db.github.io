...
<body>
    ...
    <form id="matkulForm" style="margin-bottom: 20px;">
        ...
        <input type='text' name='nama_matkul' id='nama_matkul' placeholder='Nama Matkul' style="padding: 10px; width: 200px;"><br><br>
    ...
    <br><br>
        <thead>
            <tr>
                ...
                <th style="padding: 10px; background-color: #f2f2f2; border: 1px solid #ddd;">Nama Mata Kuliah</th>
